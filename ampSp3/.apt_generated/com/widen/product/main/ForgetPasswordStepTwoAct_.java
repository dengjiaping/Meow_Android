...
public final class ForgetPasswordStepTwoAct_
    extends ForgetPasswordStepTwoAct
    implements HasViews, OnViewChangedListener
{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(layout.forget_password_step_two);
    }
    ...
    public static ForgetPasswordStepTwoAct_.IntentBuilder_ intent(Context context) {
        return new ForgetPasswordStepTwoAct_.IntentBuilder_(context);
    }

    public static ForgetPasswordStepTwoAct_.IntentBuilder_ intent(Fragment supportFragment) {
        return new ForgetPasswordStepTwoAct_.IntentBuilder_(supportFragment);
    }
        ...
        }
        {
            ...
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    @Override
                    public void onClick(View view) {
                        ForgetPasswordStepTwoAct_.this.sendverification();
                    }
    ...
    public static class IntentBuilder_ {
        ...
        public IntentBuilder_(Context context) {
            context_ = context;
            intent_ = new Intent(context, ForgetPasswordStepTwoAct_.class);
        }

        public IntentBuilder_(Fragment fragment) {
            fragmentSupport_ = fragment;
            context_ = fragment.getActivity();
            intent_ = new Intent(context_, ForgetPasswordStepTwoAct_.class);
        }
        ...
        public ForgetPasswordStepTwoAct_.IntentBuilder_ flags(int flags) {
        ...
        public ForgetPasswordStepTwoAct_.IntentBuilder_ phone(String phone) {
