...
public class SignupPaymentTask  extends IHttpTask{

	private String[] strs;
	@Override
	public String getSubUrl() {
		// TODO Auto-generated method stub
		return "/User/SignUpPayment";
	}
	...
	public String getParams() {
		try{
			...
			jobject.put("Credential",strs[3]);
			jobject.put("CredentialNo",strs[4]);
			jobject.put("RealName",strs[5]);
