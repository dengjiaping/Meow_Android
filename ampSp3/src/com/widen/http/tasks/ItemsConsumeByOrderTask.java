...
public class ItemsConsumeByOrderTask implements IHttpTask{

	private String[] strs;
	@Override
	public String getSubUrl() {
		// TODO Auto-generated method stub
		return "Api/V1/Items/ConsumeByOrder";
	}
	...
	public String getParams() {
		// TODO Auto-generated method stub
		return String.format("ItemId=%s&OrderId=%s",strs[0],strs[1]);
	}
	...
	public Object getData(JSONObject obj) throws Exception {
		// TODO Auto-generated method stub
		return Util.getJsonString(obj, "V");
	}
