...
public class CircleProgressBar extends View {
	...
	private int progressStrokeWidth2 = 4;
	//画圆所在的距形区域
	RectF oval;
	Paint paint;
	...
	public void setProgressStrokeWidth2(int progressStrokeWidth2){
		this.progressStrokeWidth2 = progressStrokeWidth2;
	}
	...
	protected void onDraw(Canvas canvas) {
		...
		paint.setStrokeWidth(progressStrokeWidth2);
