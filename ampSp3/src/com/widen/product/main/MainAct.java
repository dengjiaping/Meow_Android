			...
			public void onCheckedChanged(RadioGroup group, int checkedId) {
				if (checkedId == home.getId()) {
					FragmentTransaction fragmentTransaction = getSupportFragmentManager()
							.beginTransaction();
					homeFragment = (HomeFragment_) getSupportFragmentManager()
							.findFragmentByTag("homeFragment");

					if (homeFragment == null) {
						homeFragment = new HomeFragment_();
						fragmentTransaction.add(R.id.containerBody,
								homeFragment, "homeFragment");
					} else {
...
//					}
					...
					FragmentTransaction fragmentTransaction = getSupportFragmentManager()
							.beginTransaction();
					productFragment = (ProductFragment_) getSupportFragmentManager()
							.findFragmentByTag("productFragment");
					if (productFragment == null) {
...
//					hideCat();
				...
				// timeLineFragment = (TimeLineFragment_)
				// getSupportFragmentManager().findFragmentByTag("timeLineFragment");
				//
				//
				// if(timeLineFragment == null){
				//
				// timeLineFragment = new TimeLineFragment_();
				// fragmentTransaction.add(R.id.containerBody, timeLineFragment,
				// "timeLineFragment");
				//
				// }else{
				//
				...
				// }
					...
					FragmentTransaction fragmentTransaction = getSupportFragmentManager()
							.beginTransaction();
					moreFragment = (MoreFragment_) getSupportFragmentManager()
...
//				HttpTaskFactory.TIMELINE_CHECK);
...
//	}
	 ...
	 * 
	 * 
	 * RadioButton more; HomeFragment homeFragment;
	 * 
	 * RadioGroup radioGroup;
	 * 
	 * @Override protected void initContext() { // TODO Auto-generated method
	 * stub super.initContext(); setContentView(R.layout.home); //initView();
	 * 
	 * 
	 * }
	 * 
	 * private void initView(){ home = (RadioButton) findViewById(R.id.home);
	 * product = (RadioButton) findViewById(R.id.product); timeline =
	 * (RadioButton) findViewById(R.id.timeline); more = (RadioButton)
	 * findViewById(R.id.more); radioGroup = (RadioGroup)
	 ...
	 * 
	 * FragmentTransaction fragmentTransaction =
	 * getSupportFragmentManager().beginTransaction(); homeFragment =
	 * (HomeFragment)
	 ...
	 * fragmentTransaction.add(R.id.containerBody, homeFragment,
	 * "HomeFragment"); }else{
	 * 
	 * if(homeFragment.isDetached()){ fragmentTransaction.attach(homeFragment);
	 * } } fragmentTransaction.show(homeFragment);
	 * 
	 * radioGroup.setOnCheckedChangeListener(new OnCheckedChangeListener() {
	 * 
	 * @Override public void onCheckedChanged(RadioGroup group, int checkedId) {
	 * // TODO Auto-generated method stub if(checkedId == home.getId()){
	 * 
	 * FragmentTransaction fragmentTransaction =
	 * getSupportFragmentManager().beginTransaction(); homeFragment =
	 * (HomeFragment)
	...
	/*
	 * @ViewById RadioButton home;
	 * 
	 * @ViewById RadioButton product;
	 * 
	 * @ViewById RadioButton timeline;
	 * 
	 * @ViewById RadioButton more;
	 * 
	 * @ViewById RadioGroup radioGroup;
	 * 
	 * HomeFragment homeFragment;
	 * 
